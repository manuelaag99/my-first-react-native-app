...
export default function ListToSelect ({ onClose, restaurantId, searchQuery, sendSelectedValueFromList }) {
    ...
    if (!arrayOfValues) {
        ...
        return (
            <View style={[[ t.flex, tw.wFull, t.absolute, t.z20, t.mT12, t.shadow2xl, tw.h40 ]]}>
                {listToDisplay && (listToDisplay.length > 0) && <ScrollView keyboardShouldPersistTaps={"handled"} style={[[ t.flex, t.flexCol ], { flexGrow: 0, maxHeight: "20px" }]}>
