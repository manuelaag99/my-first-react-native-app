                        ...
                        <View style={[ t.flex, t.flexCol, tw.wAuto, tw.h3_5, t.overflowHidden, tw.bgWhite, tw.borderY, tw.borderSolid, t.justifyCenter, tw.flexGrow ]}>
                            ...
                            {listOfOrders && listOfOrders.map((order, index) => {
                                return <View key={index} style={[ t.flex, t.flexRow, tw.wFull, t.justifyCenter, tw.bgWhite, tw.borderY, tw.borderSolid, tw.mXAuto, tw.mY0 ]}>
                                    <Text style={[ tw.mY3, t.textCenter, tw.w4_6, tw.hAuto, tw.hAuto ]}>{order}</Text>
                                    <TouchableHighlight style={[ tw.w1_6, tw.bgBlue400, tw.hAuto ]} onPress={addButtonHandle} >
                                        <Text style={[tw.textCenter]}>DONE</Text>
                                    </TouchableHighlight>
                                    <TouchableHighlight style={[ tw.w1_6, tw.bgRed400, tw.hAuto ]} onPress={addButtonHandle} >
                                        <Text style={[tw.textCenter]}>DELETE</Text>
                                    </TouchableHighlight>
                                </View>
                            })}
                        </View>
